...
alias class3='cd ~/code/wdi/wdi-atx-3/wdi-atx-3-class'
alias hw3='cd ~/code/wdi/wdi-atx-3/wdi-atx-3-hw'
alias sandbox3='cd ~/code/wdi/wdi-atx-3/sandbox'

alias class4='cd ~/code/wdi/wdi-atx-4/wdi-atx-4-class'
alias hw4='cd ~/code/wdi/wdi-atx-4/wdi-atx-4-hw'
alias sandbox4='cd ~/code/wdi/wdi-atx-4/sandbox'

alias class7='cd ~/code/wdi/wdi-atx-7/wdi-atx-7-class'
alias sandbox7='cd ~/code/wdi/wdi-atx-7/sandbox'

alias hw='cd ~/code/wdi/homework'
